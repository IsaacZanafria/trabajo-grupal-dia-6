          ...
          response?.meals?.map((image) => {
            return (
              <>
                <Link to={`/inf`}><img
                  key={image.idMeal}
                  className="aspect-video w-80 h-60 object-cover rounded-xl shadow-gray-600 shadow-lg hover:scale-104 hover:border-3 hover:border-[#342821] active:border-[#5a4539] cursor-pointer"
